...
import {deleteRow, moveRow, updateRowName, insertRow, clearRowSkills, RowState} from "../../store/timeline";
...
const RowContent = ({row, index, isLast, ...props}: RowProps, ref: React.Ref<HTMLDivElement>): JSX.Element => {
